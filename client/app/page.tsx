    ...
    <div className="bg-blue-50 grainy-light">
        ...
        <div className="mx-auto max-w-6xl gap-6 pb-24 pt-20 sm:pb-32 lg:gap-x-8 lg:px-8 lg:py-40">
          <div className="w-full flex flex-col">
            ...
            <p className="mx-auto text-slate-700 mt-8 text-center text-[13px] tex-sm max-w-4xl">
              - Guy from discord ( i forgot who 💀)
            </p>

            <p className="text-center mx-auto mt-12 text-lg max-w-xl text-balance">
              <span className="font-semibold">Moderating profanity is a thankless job.</span> If you
              run a web app with any kind of user generated content, it's your responsibility to
              keep things in order. That's a challenge if your users keep dropping F-bombs like
              confetti at a toddler's birthday party.
            </p>
            ...
            <div className="grid gap-40 sm:grid-cols-2 sm:gap-16 max-w-3xl mx-auto mt-40 text-center">
              <div className="relative z-10">
                ...
                <p className="font-semibold text-lg">...scares away new visitors</p>
                <p className="mt-2 text-balance">
                  Imagine your ideal customer waddling through a minefield of four-letter words to
                  find your amazing product. Not exactly a recipe for conversion is it??
                </p>
              </div>
              ...
              <div className="relative z-10">
                ...
                <p className="mt-2 text-balance">
                  Your sweet grandma wants to see what her sunshine is doing on the internet and
                  stumbles upon your website. Do you really need her to put on a{" "}
                  <span className="font-semibold text-red-600">hazmat suit</span> first?
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-blue-50 grainy-light">
        <div className="mx-auto max-w-6xl gap-6 pb-24 pt-10 sm:pb-32 lg:gap-x-8 lg:px-8 lg:py-40">
          ...
          <p className="text-center mx-auto mt-12 text-lg max-w-xl text-balance">
            <span className="font-semibold">F@#k moderating content manually!</span> Let
            ProfanityAPI do the dirty work of keeping your user input clean.
          </p>
